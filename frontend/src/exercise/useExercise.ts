...
import { EXERCISE_DATABASE, getExercisesByGroup as getBuiltinByGroup } from '../shared/exercises'
...
export const useExercise = defineStore('exercise', () => {
  ...
  // === CRUD ===
  function add(name: string, muscleGroup: MuscleGroup, defaultPrescription: string): CustomExercise {
  ...
  function update(id: string, data: { name?: string; muscleGroup?: MuscleGroup; defaultPrescription?: string }) {
