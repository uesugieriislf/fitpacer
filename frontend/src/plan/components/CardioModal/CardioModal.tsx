    ...
    return () => (
      <div class="cardio-modal">
        <Teleport to="body">
          {props.show && (
            <div
              class="modal-overlay cardio-modal"
              onClick={(e) => {
              ...
              <div class="modal-content">
                ...
                <div class="form-group">
                  ...
                  <div class="cardio-action-grid">
                    {CARDIO_ACTIONS.map((act) => (
                      <button
                        key={act}
                        class={["chip", cardioForm.value.action === act && "chip-active"]
                          .filter(Boolean)
                          .join(" ")}
                        onClick={() => {
                          cardioForm.value.action = act;
                        }}
                      >
                        {act}
                      </button>
                ...
                <div class="form-group">
                  ...
                  <div class="stepper-row">
                    <button
                      ...
                      onClick={() => {
                        cardioForm.value.durationMinutes = Math.max(
                          5,
                          cardioForm.value.durationMinutes - 5,
                        );
                      }}
                    >
                      −
                    ...
                    <button
                      class="btn btn-ghost btn-sm"
                      onClick={() => {
                        cardioForm.value.durationMinutes = Math.min(
                          180,
                          cardioForm.value.durationMinutes + 5,
                        );
                      }}
                  ...
                  <div class="duration-quick">
                    {[20, 30, 40, 60, 90].map((d) => (
                      <button
                        ...
                        class={[
                          "chip chip-sm",
                          cardioForm.value.durationMinutes === d && "chip-active",
                        ]
                          .filter(Boolean)
                          .join(" ")}
                        onClick={() => {
                          cardioForm.value.durationMinutes = d;
                        }}
                      >
                        {d}分钟
                      </button>
                    ...
                    <button
                      class="chip chip-sm"
                      onClick={() => {
                        cardioForm.value.durationMinutes = 38;
                      }}
                    >
                      计划量
                    </button>
                ...
                <div class="form-group">
                  ...
                  <div class="stepper-row">
                    <button
                      class="btn btn-ghost btn-sm"
                      onClick={() => {
                        cardioForm.value.avgHeartRate =
                          (cardioForm.value.avgHeartRate || 120) > 60
                            ? (cardioForm.value.avgHeartRate || 120) - 5
                            : 60;
                      }}
                    >
                      −
                    ...
                    <span class="stepper-value">
                      {cardioForm.value.avgHeartRate
                        ? cardioForm.value.avgHeartRate + " bpm"
                        : "未设置"}
                    </span>
                    <button
                      class="btn btn-ghost btn-sm"
                      onClick={() => {
                        cardioForm.value.avgHeartRate = Math.min(
                          220,
                          (cardioForm.value.avgHeartRate || 120) + 5,
                        );
                      }}
                ...
                <div class="rec-section">
                  ...
                  <label class="rec-check">
                    <input
                      type="checkbox"
                      checked={cardioWarmup.value}
                      onChange={(e) =>
                        (cardioWarmup.value = (e.target as HTMLInputElement).checked)
                      }
                    />
                  ...
                  <label class="rec-check">
                    <input
                      type="checkbox"
                      checked={cardioCooldown.value}
                      onChange={(e) =>
                        (cardioCooldown.value = (e.target as HTMLInputElement).checked)
                      }
                    />
                ...
                <div class="form-actions">
                  ...
                  <button class="btn btn-primary" onClick={submitCardio}>
                    保存并完成
                  </button>
                </div>
              </div>
